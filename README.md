...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create bluecatch-6701
  fly apps create bluecatch-6701-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app bluecatch-6701
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app bluecatch-6701-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'bluecatch-6701-staging' does not match app name in config file 'bluecatch-6701'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name bluecatch-6701-db
  fly postgres attach --app bluecatch-6701 bluecatch-6701-db

  fly postgres create --name bluecatch-6701-staging-db
  fly postgres attach --app bluecatch-6701-staging bluecatch-6701-staging-db
  ```
